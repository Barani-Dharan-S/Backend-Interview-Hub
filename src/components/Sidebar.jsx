  ...
  return (
    <>
      ...
      <aside className={open ? "sidebar sidebar-open" : "sidebar"}>
        ...
        <button className={view === "roadmap" ? "roadmap-nav active" : "roadmap-nav"} aria-current={view === "roadmap" ? "page" : undefined} onClick={() => go("roadmap")}>
        ...
        <div className="sidebar-scroll">
          ...
          <nav className="topic-nav">
            {topics.map(t => (
              <button key={t.id} className={view === "questions" && topic === t.id ? "nav-item active" : "nav-item"} aria-current={view === "questions" && topic === t.id ? "page" : undefined} onClick={() => goTopic(t.id)}>
          ...
          <nav className="topic-nav">
            <button className={view === "react" ? "nav-item active" : "nav-item"} aria-current={view === "react" ? "page" : undefined} onClick={() => go("react")}>
              <span>⚛</span><label>React Learning</label><small>{contentCounts.react.total}</small>
            </button>
            <button className={view === "javascript" ? "nav-item active" : "nav-item"} aria-current={view === "javascript" ? "page" : undefined} onClick={() => go("javascript")}>
          ...
          <nav className="topic-nav">
            <button className={view === "docker" ? "nav-item active" : "nav-item"} aria-current={view === "docker" ? "page" : undefined} onClick={() => go("docker")}>
              <span>🐳</span><label>Docker</label><small>{contentCounts.docker.total}</small>
            </button>
            <button className={view === "kubernetes" ? "nav-item active" : "nav-item"} aria-current={view === "kubernetes" ? "page" : undefined} onClick={() => go("kubernetes")}>
              <span>☸</span><label>Kubernetes</label><small>{contentCounts.kubernetes.total}</small>
            </button>
            <button className={view === "cicd" ? "nav-item active" : "nav-item"} aria-current={view === "cicd" ? "page" : undefined} onClick={() => go("cicd")}>
              <span>⚙</span><label>CI/CD</label><small>{contentCounts.cicd.total}</small>
            </button>
            <button className={view === "jenkins" ? "nav-item active" : "nav-item"} aria-current={view === "jenkins" ? "page" : undefined} onClick={() => go("jenkins")}>
              <span>🔧</span><label>Jenkins</label><small>{contentCounts.jenkins.total}</small>
            </button>
            <button className={view === "github-actions" ? "nav-item active" : "nav-item"} aria-current={view === "github-actions" ? "page" : undefined} onClick={() => go("github-actions")}>
              <span>◉</span><label>GitHub Actions</label><small>{contentCounts.githubActions.total}</small>
            </button>
            <button className={view === "cloud" ? "nav-item active" : "nav-item"} aria-current={view === "cloud" ? "page" : undefined} onClick={() => go("cloud")}>
              <span>☁</span><label>Cloud & Deployment</label><small>{contentCounts.cloud.total}</small>
            </button>
            <button className={view === "production" ? "nav-item active" : "nav-item"} aria-current={view === "production" ? "page" : undefined} onClick={() => go("production")}>
          ...
          <nav className="topic-nav">
            <button className={view === "deep-dive" ? "nav-item active" : "nav-item"} aria-current={view === "deep-dive" ? "page" : undefined} onClick={() => go("deep-dive")}>
          ...
          <nav className="topic-nav">
            <button className={view === "distributed" ? "nav-item active" : "nav-item"} aria-current={view === "distributed" ? "page" : undefined} onClick={() => go("distributed")}>
          ...
          <nav className="topic-nav">
            <button className={view === "internal" ? "nav-item active" : "nav-item"} aria-current={view === "internal" ? "page" : undefined} onClick={() => go("internal")}>
          ...
          <nav className="topic-nav">
            <button className={view === "labs" ? "nav-item active" : "nav-item"} aria-current={view === "labs" ? "page" : undefined} onClick={() => go("labs")}>
          ...
          <nav className="topic-nav">
            <button className={view === "fullstack" ? "nav-item active" : "nav-item"} aria-current={view === "fullstack" ? "page" : undefined} onClick={() => go("fullstack")}>
              <span>↗</span><label>React + Spring Boot</label><small>{contentCounts.fullstack.total}</small>
            </button>
            <button className={view === "scenarios" ? "nav-item active" : "nav-item"} aria-current={view === "scenarios" ? "page" : undefined} onClick={() => go("scenarios")}>
