...
const meta = {
  progress: ['Study Progress', 'Mastery · Focus areas · Recent activity · Next study step', 'workspace@progress:~', 'PERSONAL STUDY DASHBOARD'],
...
export default function Header({ view }) {
  ...
  return <header className="topbar">
    ...
    <div className="topbar-chrome" aria-label="Learning workspace status">
      <div className="workspace-status"><span aria-hidden="true" /> LEARNING MODE</div>
