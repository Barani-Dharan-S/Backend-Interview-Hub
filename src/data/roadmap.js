...
// Complete learning journey beyond the original backend interview stages.
// These tracks are intentionally ordered as a learning path, not as an evaluation sequence.
export const learningJourney = [
  { id: "react", order: 10, icon: "⚛", name: "React", route: "react", countKey: "react", goal: "Build frontend fundamentals around components, state, effects, rendering, forms, APIs and production patterns." },
  { id: "javascript", order: 11, icon: "JS", name: "JavaScript", route: "javascript", countKey: "javascript", goal: "Understand the language and browser runtime deeply enough to reason about modern React applications." },
  { id: "fullstack", order: 12, icon: "↔", name: "Full Stack Development", route: "fullstack", countKey: "fullstack", goal: "Connect React, HTTP, Spring Boot, security, persistence and APIs into one end-to-end application." },
  { id: "scenarios", order: 13, icon: "⌁", name: "Full-Stack Scenarios", route: "scenarios", countKey: "scenarios", goal: "Reason through realistic frontend, backend, API, security, performance and production scenarios." },
  { id: "labs", order: 14, icon: "⚒", name: "Practical Labs", route: "labs", countKey: "labs", goal: "Learn by building, debugging and architecting practical backend and full-stack problems." },
  { id: "docker", order: 15, icon: "🐳", name: "Docker", route: "docker", countKey: "docker", goal: "Learn how applications become reproducible, secure and deployable containers." },
  { id: "kubernetes", order: 16, icon: "☸", name: "Kubernetes", route: "kubernetes", countKey: "kubernetes", goal: "Understand orchestration, networking, configuration, scaling, storage, rollouts and failure recovery." },
  { id: "cicd", order: 17, icon: "⚙", name: "CI/CD", route: "cicd", countKey: "cicd", goal: "Understand the delivery pipeline from commit through build, test, scan, artifact and deployment." },
  { id: "jenkins", order: 18, icon: "🔧", name: "Jenkins", route: "jenkins", countKey: "jenkins", goal: "Learn production Jenkins pipelines, credentials, agents, approvals, artifacts and deployment flows." },
  { id: "github-actions", order: 19, icon: "◉", name: "GitHub Actions", route: "github-actions", countKey: "githubActions", goal: "Build secure GitHub-native automation with workflows, environments, OIDC, artifacts and deployment strategies." },
  { id: "cloud", order: 20, icon: "☁", name: "Cloud & Deployment", route: "cloud", countKey: "cloud", goal: "Understand AWS-oriented networking, compute, storage, databases, load balancing, observability and deployment." },
  { id: "production", order: 21, icon: "🏗", name: "End-to-End Production Engineering", route: "production", countKey: "production", goal: "Connect application, database, containers, Kubernetes, CI/CD, cloud and observability into production engineering practice." },
  { id: "deep-dive", order: 22, icon: "🧠", name: "Deep Learning & Architecture", route: "deep-dive", countKey: "deepDive", goal: "Connect implementation details, internal behavior, failure modes and architecture across the stack." },
  { id: "internal", order: 23, icon: "◈", name: "Internal Workings", route: "internal", countKey: "internal", goal: "Understand what frameworks, runtimes, databases, browsers, containers and platforms are doing underneath the abstractions." },
  { id: "distributed", order: 24, icon: "🌐", name: "Distributed Systems", route: "distributed", countKey: "distributed", goal: "Master partial failure, consistency, retries, idempotency, coordination, observability and recovery reasoning." }
];
